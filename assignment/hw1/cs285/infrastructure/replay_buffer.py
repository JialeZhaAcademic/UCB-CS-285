...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        random_sample = np.random.permutation(self.acs.shape[0])[:batch_size]
        return (
            self.obs[random_sample],
            self.acs[random_sample],
            self.rews[random_sample],
            self.next_obs[random_sample],
            self.terminals[random_sample],
        )
