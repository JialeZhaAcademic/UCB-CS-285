...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            batch_idx = np.random.permutation(num_data)[:num_data_per_env]
            observations =  ob_no[batch_idx]# TODO(Q1)
            actions = ac_na[batch_idx] # TODO(Q1)
            next_observations = next_ob_no[batch_idx] # TODO(Q1)
