...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        next_obs_pred = obs_unnormalized + delta_std*(delta_pred_normalized + delta_mean) # TODO(Q1)
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        # outputs.
        prediction, _ = self(
            obs, acs, data_statistics['obs_mean'],
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        target = next_observations - observations - data_statistics['delta_mean']
        target /= data_statistics['delta_std']
        
        # TODO(Q1) compute the loss
        # Hint: `self(...)` returns a tuple, but you only need to use one of the
        # outputs.
        pred = self.get_prediction(observations, actions, data_statistics)
